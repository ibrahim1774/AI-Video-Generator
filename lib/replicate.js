...
// Video generation (single-scene + storyboard) now lives in lib/kie.js
// (kie.ai Kling 3.0). Replicate still powers nano-banana image
// generation and the face-swap motion-transfer path above.
