...
/**
 * Consume 1 credit on successful Banana generation. For trialing subs,
 * flip the one-shot trialUsed flag instead of decrementing.
 */
export async function decrementCredits(entitlement) {
