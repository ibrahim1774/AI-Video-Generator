...
export async function screenImage(url) {
  // Image scanning is intentionally disabled. Moderation now relies on
  // the prompt/script text filter only. Flip this early-return to
  // re-enable the vision classifier if needed.
  return { ok: true };
