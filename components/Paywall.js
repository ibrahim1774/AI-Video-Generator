...
const SURFACE_COPY = {
  ...
  'local-business': {
    monthlyName: 'Local Business Monthly',
    proName: 'Local Business Pro',
    yearlyName: 'Local Business Yearly',
    pickHeader: 'Pick a Local Business plan',
    pickSubtitle: 'Generate ready-to-post videos for your business. Cancel anytime.',
    monthlyFeats: [
      'Full access to AI Video generation',
      { videoCredits: true, plan: 'monthly' },
      'Top up anytime for more credits',
  ...
  'real-estate': {
    monthlyName: 'Real Estate Monthly',
    proName: 'Real Estate Pro',
    yearlyName: 'Real Estate Yearly',
    pickHeader: 'Pick a Real Estate plan',
    pickSubtitle: 'Listing reels, open-house videos, agent content. Cancel anytime.',
    monthlyFeats: [
      'Full access to AI Video generation',
      { videoCredits: true, plan: 'monthly' },
      'Top up anytime for more credits',
