...
const PHASES = [
  ...
  { label: 'Detecting faces', detail: 'Scanning frames for facial landmarks.' },
  { label: 'Encoding identity', detail: 'Building a latent identity vector.' },
  { label: 'Rendering frames', detail: 'Compositing the swapped face frame-by-frame.' },
